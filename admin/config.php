...
// DIR
define('DIR_APPLICATION', 'D:\Projects\OSTPC\Medtechnik\workspace/admin/');
...
define('DIR_LANGUAGE', 'D:\Projects\OSTPC\Medtechnik\workspace/admin/language/');
define('DIR_TEMPLATE', 'D:\Projects\OSTPC\Medtechnik\workspace/admin/view/template/');
...
define('DIR_CATALOG', 'D:\Projects\OSTPC\Medtechnik\workspace/catalog/');

// DB
define('DB_DRIVER', 'mysqli');
define('DB_HOSTNAME', 'localhost');
define('DB_USERNAME', 'oc_admin');
define('DB_PASSWORD', 'nimda_co');
define('DB_DATABASE', 'medtehnik');
