...
<div id="main">
	...
	<div id="sliderwrap">
        ...
        $nodes = uniq_get_nodes('frontpage_slider');

        foreach($nodes as $node):
        $node_uri = drupal_lookup_path('alias','node/' . $node->nid);

        ?>
			<img src="/<?php print variable_get('file_public_path') . '/frontpage_slider/' . $node->field_slider_img['und'][0]['filename']; ?>" alt="<?php print $node->title; ?>">
        <?php endforeach; ?>
        </div>
		<!-- End Slider -->
	...
	<div id="main-wrap">
        ...
        <div class="boxes-third <?php if($ind == 1): ?>boxes-first<?php elseif($ind == 3): ?>boxes-last<?php endif; ?>">
            <a href="<?php print '/' . $node_uri; ?>">
                <div class="latestthree">
                    <div class="title"> <?php print $node->title; ?> <span class="titlearrow"></span> </div>
                    <div class="latestthreeimage"><img src="/<?php print variable_get('file_public_path') . '/portfolio/thumb/' . $node->field_port_thumb['und'][0]['filename']; ?>" alt="<?php print $node->title; ?>" width="305" height="132" border="0"></div>
