...
<div id="header">
    ...
    <div id="header_small">
        ...
        <div id="header-button">
            <a class="header-button" href="#">ЗАДАТЬ ВОПРОС ОНЛАЙН</a>
        ...
        <div class="leftsection">
            ...
            <div class="blogwrapstart">
                <div class="blogbody" style="padding:0">
                    <div class="blogtitle">
                        <h3 style="color: #da620b;font-weight: normal;">Понравилась работа? - Оставьте отзыв.</h3>
                    </div>
                    <!-- Start Blog Text -->
                    <div class="blogtext" style="padding-top:0">
                        ...
                        <p>
                            ...
                            <script type="text/javascript">
                                VK.init({apiId: 3903265, onlyWidgets: true});
                            </script>
