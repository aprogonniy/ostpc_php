...
<?php if(arg(0) != 'taxonomy') : ?>
    ...
    <div id="main">
        ...
        <div id="main-wrap">
            ...
            <?php endif; ?>
            <?php if(isset($node) && ($node->type == 'portfolio_item' || $node->type == 'news_item')): ?>
                <?php print render($page['content']); ?>
            <?php else: ?>
            <!-- Start Full Width -->
            <div class="boxes-full wellcome-text boxes-padding fullpadding">
                <?php print render($page['content']); ?>
            </div>
            <!-- End Full Width -->
            <?php endif; ?>
    ...
    <div id="main">
        ...
        <div id="main-wrap">
            ...
            <div class="leftsection">
                ...
                $nodes = taxonomy_select_nodes(arg(2), FALSE);
                $id = 0;

                if(count($nodes)) {
                    foreach($nodes as $idn):
                    $node = node_load($idn);
                    $node_uri = drupal_lookup_path('alias','node/' . $node->nid);
                    ?>
                    <!-- Start Blog Post -->
                    <div class="<?php if($id == 0) : ?>blogwrapstart<?php else : ?>blogwrap<?php endif; ?>">
                        <div class="blogtitle">
                            <h3 style="font-weight: normal;"><a href="<?php print '/' . $node_uri; ?>"><?php print $node->title; ?></a></h3>
                        </div>
                        <div class="blogbody">
                            <!-- Start Blog Text -->
                            <div class="blogtext" style="padding-top:0;">
                                <p style="margin-top:0;"><?php if($node->body['und'][0]['summary'] != '') : print $node->body['und'][0]['summary']; else : print 'Нет краткого описания'; endif; ?></p>
                                <p class="blogbutton"><a class="read-more-button" href="<?php print '/' . $node_uri; ?>">Читать полностью</a></p>
                            </div>
                            <!-- End Blog Text -->
                        </div>
                    ...
                    <div class="blogwrapstart">
                        <div class="blogbody">
                            <!-- Start Blog Text -->
                            <div class="blogtext" style="padding-top:0;">
                                <p style="text-align:center">Для данной категории нет новостей.</p>
                            </div>
                            <!-- End Blog Text -->
                        </div>
                    </div>
                ...
                <div class="blogwrap">
                    <div class="blogpagination">
                        <ul>
                            <li><a href="#" class="normal">Start</a></li>
                            <li><a href="#" class="normal">&lt;Prev</a></li>
                            <li><a href="#" class="normal">1</a></li>
                            <li><a href="#" class="normal">2</a></li>
                            <li><a href="#" class="normal">3</a></li>
                            <li><a href="#" class="normal">4</a></li>
                            <li><a href="#" class="normalactive">5</a></li>
                            <li><a href="#" class="normal">6</a></li>
                            <li><a href="#" class="normal">7</a></li>
                            <li><a href="#" class="normal">8</a></li>
                            <li><a href="#" class="normal">9</a></li>
                            <li><a href="#" class="normal">10</a></li>
                            <li><a href="#" class="normal">Next&gt;</a></li>
                            <li><a href="#" class="normal">Last</a></li>
                        </ul>
                    </div>
                </div>
                 End Pagination -->
                        ...
                        <div class="blogcategories">
                            <ul>
                                <?php foreach($terms as $term): ?>
                                    ...
                                    ?>
                                    <li <?php if(arg(2) == $term->tid) : ?> class="current-category-selected"<?php endif; ?>><a href="/<?php print $term_path; ?>"><?php print $term->name; ?></a></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                    </div>
