...
jQuery(function () {
    ...
    if($('#admin-menu').length > 0) {
        $('#naviagtion').css({top: '30px'});
    }

    function detectFooterTopHeight() {
        ...
        return win_h - header_h - main_h - footer_h - nav_h / 2;
    }

    var footer_top_h = detectFooterTopHeight();
    if(footer_top_h > 0 && $('#footertop').length > 0) {
        $('#footertop').height(footer_top_h + 'px');
    }
});;
jQuery(function () {
    $ = jQuery;
