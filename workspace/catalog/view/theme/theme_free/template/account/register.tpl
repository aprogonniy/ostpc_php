        ...
        <div class="content">
          <table class="form">
            ...
            <tr style="display: <?php echo (count($customer_groups) > 1 ? 'table-row' : 'none'); ?>;">
              ...
              <td><select class="q1" name="customer_group_id">
            ...
            <tr id="company-id-display">
              ...
              <td><input class="q1" type="text" name="company_id" value="<?php echo $company_id; ?>" />
            ...
            <tr id="tax-id-display">
              ...
              <td><input class="q1" type="text" name="tax_id" value="<?php echo $tax_id; ?>" />
                <?php if ($error_tax_id) { ?>
