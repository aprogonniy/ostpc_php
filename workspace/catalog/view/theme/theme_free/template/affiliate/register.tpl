        ...
        <div class="content">
          <table class="form">
            ...
            <tr>
              ...
              <td><select class="q1" name="country_id" onchange="$('select[name=\'zone_id\']').load('index.php?route=account/register/zone&country_id=' + this.value + '&zone_id=<?php echo $zone_id; ?>');">
