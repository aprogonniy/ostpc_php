...
<div id="content">
	...
	<div class="box">
		...
		<?php foreach ($modules as $module) { ?>
			...
			<?php if ($module['position'] == 'content_header_block') { ?>
			<option value="content_header_block" selected="selected"><?php echo $text_content_header_block; ?></option>
			<?php } else { ?>
			<option value="content_header_block"><?php echo $text_content_header_block; ?></option>
			<?php } ?>
			...
			<table id="layout_sort_<?php echo $module_row; ?>" class="form" style=" <?php if ($module['position'] == 'content_footer' || $module['position'] == 'content_header_block' || $module['position'] =='content_footer_block') echo 'display:none'; else echo 'display:block';?>" cl > 
...
html += '        <option value="content_footer_block"><?php echo $text_content_header_block; ?></option>';
html += '      </select></td>';
html += '    </tr>';
html += '    <tr>';
...
{
if(val=='content_footer' || val=='content_footer_block' || val=='content_header_block') 
{
